"""
Django settings for medicalServer project.
...
SECRET_KEY = '1=6kpfb!dx-o(j7cf&#n(_if!q7slk%hnd5ec3--8@m(ly7sa='
...
ROOT_URLCONF = 'medicalServer.urls'
...
WSGI_APPLICATION = 'medicalServer.wsgi.application'
